...
% Create ground truth
dir={'F:\Box Sync\Bioengineering\Research\Dr. Wong Lab\Data\MATLAB\SCM-Sandbox\RCNN-Segm\RCNN-SCM-gTruth\Trial'};
...
if exist('I1.jpg', 'file') == 2
    ...
    % divide images into 4 smaller regions
    [a,b,~]=size(I);
...
if exist('L1.png','file')==2
    ...
    L=imread(fullfile(char(labelDir),'Label_223.png')); %verify with Edit>Colormap>Color data max: 3
    L=im2single(L);
